...
<form action="/writeAction.do" method="post" >     
	<div class="container" >
		 <table class="table table-striped" style="text-align: center">
		  ...
		  <tbody>
		    <tr>
		      <th scope="row"><input type="text" class="form-control" placeholder="글 제목" name="bbsTitle" maxlength="50"/></th>
		    </tr>
		    <tr>
		      <th><textarea style="height: 350px" class="form-control" placeholder="글 내용" name="bbsContent" maxlength="2048"></textarea> </th>
		    </tr>
		  </tbody>
		</table>	
		...
		<button type="submit" class="btn btn-primary float-right" style="display: block;width:100px%">글 쓰기</button>
	</div>
</form>